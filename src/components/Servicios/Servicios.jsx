...
function Servicios () {
    return (
        ...
        <main className="servicios-container">
            <div className="redes">
            <img className="img-servicios" src={redes} />
                <div className="servicios-informacion">
                    <h3>Diseño web</h3>
                    <p>Construimos comunidades digitales sólidas y comprometidas. Desde estrategias de contenido hasta la gestión diaria, aseguramos que tu marca destaque en plataformas como Facebook, Instagram, TikTok, entre otras.</p>
                </div>
            </div>

            <div className="web">
            <img className="img-servicios" src={web} />
                <div className="servicios-informacion">
